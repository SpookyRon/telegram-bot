class ReservationForm extends HTMLElement {
  ...
  async loadData () {
    this.data = {
      ...
      info: 'find your perfect spot at our restaurant and make your reservation today to enjoy an unforgettable dining experience.',
      instructions: 'Te enviaremos un correo electrónico si la reserva es exitosa.',
      textButton: 'Reservar mesa'
    }
  }
