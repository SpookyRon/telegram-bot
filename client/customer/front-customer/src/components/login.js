class Login extends HTMLElement {
  ...
  async loadData () {
    try {
      const response = await fetch(`/api/customer/Login/${this.getAttribute('name')}`)
  ...
  render () {
    ...
    <style>
      ...
      *{
      ...
      .Login-footer-background-waves,
      .Login-footer-background-color {
        margin: 0;
        padding: 0;
      }
      ...
      .Login-footer-background-waves svg{
        display: block; 
        fill: hsl(200, 77%, 52%);
        width: 100%;
      }
    ...
    <section class="Login">
      <div class="Login-info">
        ...
        <div class="Login-button">
          <a href="${this.data.buttonLink}" aria-label="Comenzar">
      ...
      <div class="Login-image">
        <picture>
          <source srcset="./images/Login.webp" media="(min-width: 1920px)">
          <source srcset="./images/Login.webp" media="(min-width: 1024px)">
          <source srcset="./images/Login.webp" media="(min-width: 768px)">
          <source srcset="./images/Login.webp" media="(min-width: 480px)">
          <img src="./images/Login.webp" alt="Imagen de prueba de Picsum">
        </picture>
      </div>

      <div class="Login-footer">
        <div class="Login-footer-background-waves">
        ...
        <div class="Login-footer-background-color"></div>
      </div> 
    </section>
    `
  }
