...
// req.query es cuando pones un ? en la url, por ejemplo: http://localhost:3000/api/v1/admin/Customers?name=Juan&age=30
...
// los params los tienes que declarar en la ruta, por ejemplo: http://localhost:3000/api/v1/admin/Customers/1
